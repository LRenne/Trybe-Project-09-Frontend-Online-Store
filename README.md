...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-023-a-project-frontend-online-store.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-023-a-project-frontend-online-store`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-023-a-project-frontend-online-store/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-023-a-project-frontend-online-store/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  - Ao adicionar um produto a partir da tela inicial e clicar no carrinho de compras, espera-se que nenhuma requisição(fetch) seja feita.
</details>
